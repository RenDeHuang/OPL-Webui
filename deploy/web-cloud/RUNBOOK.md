...
```text
run id: 28422674169
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28422674169
commit: ba32d695e186e30fc2133002c59b2b7c781f4eb3
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:ba32d69
...
- 本 harness 已在 GitHub Actions run `28422674169` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
