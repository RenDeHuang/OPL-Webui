...
```text
run id: 28310892323
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28310892323
commit: 807b46ad14ee0f569be6ed19c6d49f5f197e4903
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:807b46a
...
- 本 harness 已在 GitHub Actions run `28310892323` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28310892323
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28310892323
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28310892323/job/83875518998
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:807b46a
browser: chromium
