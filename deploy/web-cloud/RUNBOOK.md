...
```text
run id: 28421665376
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28421665376
commit: 9465b3ef9699a9cbc3d915804618be70d3bb0dcd
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:9465b3e
...
- 本 harness 已在 GitHub Actions run `28421665376` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28421665376
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28421665376
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28421665376/job/84202607112
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:9465b3e
browser: chromium
