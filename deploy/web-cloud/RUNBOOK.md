...
```text
run id: 28282021822
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28282021822
commit: d9f50522e1f116a6f8d9827c33bc0b08a4e1f721
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:d9f5052
...
- 本 harness 已在 GitHub Actions run `28282021822` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28282021822
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28282021822
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28282021822/job/83799649171
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:d9f5052
browser: chromium
