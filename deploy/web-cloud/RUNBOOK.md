...
```text
run id: 28311779032
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28311779032
commit: cbc053ce3be204f1a6edfb0bfb456bd71be2666a
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:cbc053c
...
- 本 harness 已在 GitHub Actions run `28311779032` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28311779032
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28311779032
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28311779032/job/83877864475
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:cbc053c
browser: chromium
