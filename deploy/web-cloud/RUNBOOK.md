...
```text
run id: 28245417027
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28245417027
commit: 3d1339d168267da9b37dc24ab3b7fc0b4d32aa57
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:3d1339d
real chat: true (confirmed by production browser e2e in the same run)
readonly projection: confirmed; OPL_PRODUCTION_DOGFOOD_MEDOPL_READONLY=1 sanitized evidence folded back without raw logs
...
- 本 harness 已在 GitHub Actions run `28245417027` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28245417027
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28245417027
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28245417027/job/83683401916
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:3d1339d
browser: chromium
