...
```text
run id: 28288977612
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28288977612
commit: 639a627977aede723a66017cee22dc4e848d2bc0
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:639a627
...
- 本 harness 已在 GitHub Actions run `28288977612` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28288977612
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28288977612
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28288977612/job/83817734761
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:639a627
browser: chromium
