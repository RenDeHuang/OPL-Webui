...
```text
run id: 28323165665
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28323165665
commit: 496261981494952a199d70e08cc0821d9e927eb3
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:4962619
...
- 本 harness 已在 GitHub Actions run `28323165665` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28323165665
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28323165665
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28323165665/job/83908778900
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:4962619
browser: chromium
