...
```text
run id: 28312150030
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28312150030
commit: 1c71ddc05deceda3d2f2cebde06d2fefb2a0fc31
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:1c71ddc
...
- 本 harness 已在 GitHub Actions run `28312150030` 成功执行；后续只有新的成功 run 才能替换 latest compressed evidence。
...
run id: 28312150030
run URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28312150030
job URL: https://github.com/RenDeHuang/OPL-Webui/actions/runs/28312150030/job/83878913845
target host: https://opl.medopl.cn
image: uswccr.ccs.tencentyun.com/webopl/opl-webui:1c71ddc
browser: chromium
