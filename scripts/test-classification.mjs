...
const TEST_ENTRIES = Object.freeze([
  ...
  testEntry({
    ...
    proves: ['CI/local Chromium research main path works with user-like interaction, sanitized evidence, artifact-first research results, stable desktop inspector, lightweight mobile sheet, responsive visual QA, and repo-local keyboard path, modal focus trap, and contrast closeout checks'],
