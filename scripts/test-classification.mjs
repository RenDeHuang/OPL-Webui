...
const TEST_ENTRIES = Object.freeze([
  ...
  testEntry({
    ...
    proves: ['Go control plane bridges MedOPL runtime gate, runtime runs, billing ledger refs, typed blockers, and refs-only projection without owning execution or billing truth'],
    doesNotProve: [...NOT_PRODUCTION_EVIDENCE, 'MedOPL production runtime execution', 'billing source of truth', 'artifact body authority', 'domain truth'],
