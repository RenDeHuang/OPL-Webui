...
const TEST_ENTRIES = Object.freeze([
  ...
  testEntry({
    ...
    proves: ['Go control plane bridges MedOPL runtime gate, runtime runs, billing ledger refs, typed blockers, refs-only projection, and real MedOPL local response shapes without owning execution or billing truth'],
    doesNotProve: [...NOT_PRODUCTION_EVIDENCE, 'MedOPL production runtime execution', 'sandbox account lifecycle', 'billing source of truth', 'external payment settlement', 'artifact body authority', 'domain truth'],
