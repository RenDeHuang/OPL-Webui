const TEST_ENTRIES = Object.freeze([
  ...
  Object.freeze({
    file: 'tests/health/product-debt-retirement.test.mjs',
    runner: 'node',
    lane: 'health',
    ownerSurface: 'repo-governance',
    lifecycleRole: 'current-owner',
    contracts: Object.freeze(['AGENTS.md', 'TASTE.md', 'changes/README.md', 'scripts/repo-bloat-audit.mjs']),
    verifySuites: Object.freeze(['current', 'health']),
  }),
  Object.freeze({
    ...
    lifecycleRole: 'current-owner',
    contracts: Object.freeze(['changes/README.md', 'changes/archive/closeouts.md', 'docs/active/README.md', 'deploy/web-cloud/RUNBOOK.md', 'contracts/web-product-profile.json', 'contracts/web-api.openapi.json', 'contracts/web-release-profile.json']),
