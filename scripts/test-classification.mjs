const TEST_ENTRIES = Object.freeze([
  ...
  Object.freeze({
    ...
    lifecycleRole: 'current-owner',
    contracts: Object.freeze(['tests/browser/research-main-path-runner.mjs', 'contracts/web-page-state-matrix.json', 'contracts/web-release-profile.json']),
    verifySuites: Object.freeze(['current', 'health']),
  }),
  ...
  Object.freeze({
    ...
    lifecycleRole: 'current-owner',
    contracts: Object.freeze(['services/control-plane-go/cmd/opl-webui-control-plane/main.go', 'services/control-plane-go/internal/webapp/handlers.go', 'services/control-plane-go/internal/webapp/canary.go']),
    verifySuites: Object.freeze(['current', 'contract']),
  }),
  Object.freeze({
