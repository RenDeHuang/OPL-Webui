...
const TEST_ENTRIES = Object.freeze([
  ...
  testEntry({
    ...
    proves: ['CI/local Chromium research main path works with user-like interaction, sanitized evidence, and repo-local desktop/mobile visual baseline checks'],
    doesNotProve: ['production-ready SaaS', 'long-term production stability', 'MedOPL runtime execution', 'complete UI/UX design system', 'production visual polish complete'],
