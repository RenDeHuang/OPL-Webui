...
const TEST_ENTRIES = Object.freeze([
  ...
  testEntry({
    ...
    proofLevel: 'static',
    claimScope: 'repo',
    contracts: ['contracts/web-shell-adapter.json', 'contracts/web-surface-inventory.json', 'frontend/web/src/onePersonLabWeb.mjs', 'tests/contract/helpers/web-source-reader.mjs'],
  ...
  testEntry({
    ...
    proofLevel: 'unit',
    claimScope: 'repo',
    contracts: ['frontend/web/src/onePersonLabWeb.mjs', 'contracts/web-page-state-matrix.json', 'contracts/web-runtime-bridge.json'],
  ...
  testEntry({
    ...
    proofLevel: 'static',
    claimScope: 'repo',
    contracts: ['frontend/web/index.html', 'frontend/web/styles.css', 'frontend/web/src/onePersonLabWeb.mjs', 'contracts/web-gui-product-contract.json'],
  ...
  testEntry({
    ...
    proofLevel: 'browser',
    claimScope: 'ci',
    contracts: ['tests/browser/research-main-path-runner.mjs', 'tests/browser/helpers/browser-cdp-helper.mjs', 'contracts/web-page-state-matrix.json', 'contracts/web-release-profile.json', 'contracts/web-gui-product-contract.json', 'contracts/web-product-profile.json', 'contracts/web-runtime-bridge.json'],
