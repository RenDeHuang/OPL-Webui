...
test('one-person-lab-web contracts define product truth instead of prose specs', () => {
  ...
  assert.deepEqual(gui.informationArchitecture.sideNavigationTaskOwnership, { home: 'compose_or_start_research_task', projects: 'browse_project_windows_and_continue', skills: 'browse_or_import_skill_entries', workflows: 'browse_create_or_import_agentic_research_workflows', search: 'open_project_window_search', more: 'route_empty_overflow_surface' });
