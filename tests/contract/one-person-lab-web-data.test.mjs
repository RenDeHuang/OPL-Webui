...
test('one-person-lab-web contracts define product truth instead of prose specs', () => {
  ...
  assert.equal(release.productionDogfoodReadiness.latestSuccessfulRun.runUrl, 'https://github.com/RenDeHuang/OPL-Webui/actions/runs/28282021822');
  ...
  assert.equal(release.productionAvailabilityReadiness.latestSuccessfulRun.runUrl, 'https://github.com/RenDeHuang/OPL-Webui/actions/runs/28282021822');
  ...
  assert.equal(release.productionObservabilityBaseline.latestSuccessfulRun.runUrl, 'https://github.com/RenDeHuang/OPL-Webui/actions/runs/28282021822');
  ...
  assertIncludesAll(gui.designQualityGates.navigation.required, ['search_is_conversation_history', 'more_is_empty_overflow', 'bottom_avatar_account_entry', 'optional_model_selector'], 'navigation design quality gate');
  ...
  assert.equal(gui.components.find((component) => component.id === 'SearchPanel').role, 'conversation_history_search');
